...
# )
st.markdown(f"<center style='font-family:@import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@700&display=swap') ; color:{color_decision}; font-size: 60px;'>{litteral_decision.upper()}</center>",
